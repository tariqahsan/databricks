...
for all 6 OE data sources.

Run from inside the Jupyter terminal:
    cd /home/jovyan
...
Prerequisites:
    1. Generate mock logs first:
       python /home/jovyan/generate_mock_logs.py --days 1
    2. Spark session must be initialized with local[2] master.
"""
...
# Ensure local[2] is used — prevents version mismatch with remote worker
